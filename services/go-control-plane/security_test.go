...
func TestUIRoutesRejectCrossOriginPosts(t *testing.T) {
	...
	routes := []string{
		"/ui/workers/worker-1/pause",
		"/ui/workers/worker-1/resume",
		"/ui/workers/worker-1/drain",
		"/ui/workers/worker-1/stop",
		"/ui/workers/worker-1/quarantine",
		"/ui/workers/worker-1/unquarantine",
		"/ui/workers/servers",
		"/ui/workers/servers/1",
		"/ui/workers/servers/1/provision",
		"/ui/workers/servers/1/command",
		"/ui/provisioning/servers",
		"/ui/provisioning/servers/1",
		"/ui/provisioning/servers/1/provision",
		"/ui/provisioning/servers/1/verify",
		"/ui/provisioning/servers/1/command",
		"/ui/servers",
		"/ui/servers/1",
		"/ui/servers/1/edit",
		"/ui/servers/1/provision",
		"/ui/servers/1/command",
		"/ui/servers/1/delete",
		"/ui/pools",
		"/ui/pools/1",
		"/ui/pools/1/archive",
		"/ui/pools/1/set-default",
		"/ui/pools/default/scale",
		"/ui/settings",
		"/ui/settings/rollback",
		...
		"/verifier-engine-room/workers/worker-1/stop",
		"/verifier-engine-room/workers/worker-1/quarantine",
		"/verifier-engine-room/workers/worker-1/unquarantine",
		"/verifier-engine-room/workers/servers",
		"/verifier-engine-room/workers/servers/1",
		"/verifier-engine-room/workers/servers/1/provision",
		"/verifier-engine-room/workers/servers/1/command",
		"/verifier-engine-room/provisioning/servers",
		"/verifier-engine-room/provisioning/servers/1",
		"/verifier-engine-room/provisioning/servers/1/provision",
		"/verifier-engine-room/provisioning/servers/1/verify",
		"/verifier-engine-room/provisioning/servers/1/command",
		"/verifier-engine-room/servers",
		"/verifier-engine-room/servers/1",
		"/verifier-engine-room/servers/1/edit",
		"/verifier-engine-room/servers/1/provision",
