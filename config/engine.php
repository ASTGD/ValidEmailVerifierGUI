...
return [
    ...
    'worker_image_channel' => env('ENGINE_WORKER_IMAGE_CHANNEL', 'stable'),
    'worker_image_stable_tag' => env('ENGINE_WORKER_IMAGE_STABLE_TAG', 'stable'),
    'worker_image_canary_tag' => env('ENGINE_WORKER_IMAGE_CANARY_TAG', 'canary'),
    'worker_image_digest' => env('ENGINE_WORKER_IMAGE_DIGEST'),
    ...
    'worker_runtime_restart_policy' => env('ENGINE_WORKER_RUNTIME_RESTART_POLICY', 'unless-stopped'),
    'worker_runtime_hardening_enabled' => (bool) env('ENGINE_WORKER_RUNTIME_HARDENING_ENABLED', true),
    'worker_runtime_read_only' => (bool) env('ENGINE_WORKER_RUNTIME_READ_ONLY', true),
    'worker_runtime_no_new_privileges' => (bool) env('ENGINE_WORKER_RUNTIME_NO_NEW_PRIVILEGES', true),
    'worker_runtime_cap_drop_all' => (bool) env('ENGINE_WORKER_RUNTIME_CAP_DROP_ALL', true),
    'worker_runtime_tmpfs_size_mb' => (int) env('ENGINE_WORKER_RUNTIME_TMPFS_SIZE_MB', 64),
