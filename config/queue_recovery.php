...
return [
    ...
    'allow_lanes' => array_values(array_filter(array_map(
        'trim',
        explode(',', (string) env('QUEUE_RECOVERY_ALLOW_LANES', 'default,prepare,parse,smtp_probe,finalize,imports,cache_writeback,seed_send_dispatch,seed_send_events,seed_send_reconcile'))
    ))),
];
