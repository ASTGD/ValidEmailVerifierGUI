            ...
            ->components([
                ...
                Group::make([
                    Section::make('SMTP Identity')
                        ...
                        ->columns(2),
                    Section::make('Engine Provisioning')
                        ->schema([
                            View::make('filament.resources.engine-servers.partials.provisioning-block')
                                ->viewData(fn ($livewire): array => method_exists($livewire, 'provisioningViewData')
                                    ? $livewire->provisioningViewData()
                                    : []),
                        ])
